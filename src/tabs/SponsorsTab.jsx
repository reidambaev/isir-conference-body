...
const SponsorsTab = () => {
  ...
  if (showContactForm) {
    return <SponsorshipContactForm onClose={() => setShowContactForm(false)} />;
  }
  ...
  return (
    <div role="tabpanel">
      ...
      <p className="text-gray-700 mb-6">
        ...
        leaders in reproductive immunology, women&apos;s health, and
        reproductive medicine at BEXCO, Busan, November 5–8, 2026.
      </p>
      ...
      {/* Secondary Sponsor - HI Fertility Center */}
      <div className="mb-10">
        <div className="bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 p-6 rounded-2xl border-2 border-gray-300 shadow-lg">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Logo Section */}
            <div className="w-full bg-white rounded-xl p-6 shadow-sm border border-gray-200 flex items-center justify-center min-h-[200px]">
              <img
                src="/hi-fertility-center-logo.png"
                alt="HI Fertility Center"
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-base mb-4">
                We are also highly appreciative of HI Fertility Center for their
                generous contribution and ongoing support of ISIR 2026.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-10">
        ...
        <p className="text-gray-700 mb-6">
          ...
          decision-makers in reproductive healthcare. Customized opportunities
