...
-- Post-registration accompanying person add-on purchases (Stripe)
CREATE TABLE
...
-- Admin-created remaining-balance invoices (post-registration Stripe)
CREATE TABLE
...
CREATE TABLE
    IF NOT EXISTS abstractions (
        ...
        format_email_sent_at INTEGER,
        oral_session TEXT,
        oral_session_assigned_at INTEGER,
        oral_session_email_sent_at INTEGER,
        poster_session TEXT,
